...
(cl:defmethod cl:initialize-instance :after ((m <UAVControlState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UAVControlState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name prometheus_msgs-msg:<UAVControlState> is deprecated: use prometheus_msgs-msg:UAVControlState instead.")))
...
(cl:defmethod pos_controller-val ((m <UAVControlState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:pos_controller-val is deprecated.  Use prometheus_msgs-msg:pos_controller instead.")
  (pos_controller m))

(cl:ensure-generic-function 'failsafe-val :lambda-list '(m))
(cl:defmethod failsafe-val ((m <UAVControlState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:failsafe-val is deprecated.  Use prometheus_msgs-msg:failsafe instead.")
  (failsafe m))
