...
(cl:defmethod cl:initialize-instance :after ((m <GlobalAruco>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GlobalAruco)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name prometheus_msgs-msg:<GlobalAruco> is deprecated: use prometheus_msgs-msg:GlobalAruco instead.")))
