...
(cl:defmethod cl:initialize-instance :after ((m <VisionDiff>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VisionDiff)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name prometheus_msgs-msg:<VisionDiff> is deprecated: use prometheus_msgs-msg:VisionDiff instead.")))
...
(cl:defmethod detect-val ((m <VisionDiff>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:detect-val is deprecated.  Use prometheus_msgs-msg:detect instead.")
  (detect m))

(cl:ensure-generic-function 'objectX-val :lambda-list '(m))
(cl:defmethod objectX-val ((m <VisionDiff>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:objectX-val is deprecated.  Use prometheus_msgs-msg:objectX instead.")
  (objectX m))

(cl:ensure-generic-function 'objectY-val :lambda-list '(m))
(cl:defmethod objectY-val ((m <VisionDiff>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:objectY-val is deprecated.  Use prometheus_msgs-msg:objectY instead.")
  (objectY m))

(cl:ensure-generic-function 'objectWidth-val :lambda-list '(m))
(cl:defmethod objectWidth-val ((m <VisionDiff>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:objectWidth-val is deprecated.  Use prometheus_msgs-msg:objectWidth instead.")
  (objectWidth m))

(cl:ensure-generic-function 'objectHeight-val :lambda-list '(m))
(cl:defmethod objectHeight-val ((m <VisionDiff>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:objectHeight-val is deprecated.  Use prometheus_msgs-msg:objectHeight instead.")
  (objectHeight m))

(cl:ensure-generic-function 'frameWidth-val :lambda-list '(m))
(cl:defmethod frameWidth-val ((m <VisionDiff>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:frameWidth-val is deprecated.  Use prometheus_msgs-msg:frameWidth instead.")
  (frameWidth m))

(cl:ensure-generic-function 'frameHeight-val :lambda-list '(m))
(cl:defmethod frameHeight-val ((m <VisionDiff>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:frameHeight-val is deprecated.  Use prometheus_msgs-msg:frameHeight instead.")
  (frameHeight m))

(cl:ensure-generic-function 'kp-val :lambda-list '(m))
(cl:defmethod kp-val ((m <VisionDiff>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:kp-val is deprecated.  Use prometheus_msgs-msg:kp instead.")
  (kp m))

(cl:ensure-generic-function 'ki-val :lambda-list '(m))
(cl:defmethod ki-val ((m <VisionDiff>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:ki-val is deprecated.  Use prometheus_msgs-msg:ki instead.")
  (ki m))

(cl:ensure-generic-function 'kd-val :lambda-list '(m))
(cl:defmethod kd-val ((m <VisionDiff>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:kd-val is deprecated.  Use prometheus_msgs-msg:kd instead.")
  (kd m))

(cl:ensure-generic-function 'ctlMode-val :lambda-list '(m))
(cl:defmethod ctlMode-val ((m <VisionDiff>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:ctlMode-val is deprecated.  Use prometheus_msgs-msg:ctlMode instead.")
  (ctlMode m))

(cl:ensure-generic-function 'currSize-val :lambda-list '(m))
(cl:defmethod currSize-val ((m <VisionDiff>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:currSize-val is deprecated.  Use prometheus_msgs-msg:currSize instead.")
  (currSize m))

(cl:ensure-generic-function 'maxSize-val :lambda-list '(m))
(cl:defmethod maxSize-val ((m <VisionDiff>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:maxSize-val is deprecated.  Use prometheus_msgs-msg:maxSize instead.")
  (maxSize m))

(cl:ensure-generic-function 'minSize-val :lambda-list '(m))
(cl:defmethod minSize-val ((m <VisionDiff>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:minSize-val is deprecated.  Use prometheus_msgs-msg:minSize instead.")
  (minSize m))

(cl:ensure-generic-function 'trackIgnoreError-val :lambda-list '(m))
(cl:defmethod trackIgnoreError-val ((m <VisionDiff>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:trackIgnoreError-val is deprecated.  Use prometheus_msgs-msg:trackIgnoreError instead.")
  (trackIgnoreError m))

(cl:ensure-generic-function 'autoZoom-val :lambda-list '(m))
(cl:defmethod autoZoom-val ((m <VisionDiff>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:autoZoom-val is deprecated.  Use prometheus_msgs-msg:autoZoom instead.")
  (autoZoom m))
