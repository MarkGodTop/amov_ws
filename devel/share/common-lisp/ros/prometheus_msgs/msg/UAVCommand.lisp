...
(cl:defmethod cl:initialize-instance :after ((m <UAVCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UAVCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name prometheus_msgs-msg:<UAVCommand> is deprecated: use prometheus_msgs-msg:UAVCommand instead.")))
...
(cl:defmethod Agent_CMD-val ((m <UAVCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:Agent_CMD-val is deprecated.  Use prometheus_msgs-msg:Agent_CMD instead.")
  (Agent_CMD m))

(cl:ensure-generic-function 'Control_Level-val :lambda-list '(m))
(cl:defmethod Control_Level-val ((m <UAVCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:Control_Level-val is deprecated.  Use prometheus_msgs-msg:Control_Level instead.")
  (Control_Level m))
...
(cl:defmethod att_ref-val ((m <UAVCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:att_ref-val is deprecated.  Use prometheus_msgs-msg:att_ref instead.")
  (att_ref m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<UAVCommand>)))
  ...
  "26db8d0e36f9fff502c5b4828142b73d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'UAVCommand)))
  "Returns md5sum for a message object of type 'UAVCommand"
  "26db8d0e36f9fff502c5b4828142b73d")
