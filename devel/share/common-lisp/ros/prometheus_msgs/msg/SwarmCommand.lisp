...
(cl:defmethod swarm_num-val ((m <SwarmCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:swarm_num-val is deprecated.  Use prometheus_msgs-msg:swarm_num instead.")
  (swarm_num m))

(cl:ensure-generic-function 'swarm_location_source-val :lambda-list '(m))
(cl:defmethod swarm_location_source-val ((m <SwarmCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:swarm_location_source-val is deprecated.  Use prometheus_msgs-msg:swarm_location_source instead.")
  (swarm_location_source m))

(cl:ensure-generic-function 'Swarm_CMD-val :lambda-list '(m))
(cl:defmethod Swarm_CMD-val ((m <SwarmCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:Swarm_CMD-val is deprecated.  Use prometheus_msgs-msg:Swarm_CMD instead.")
  (Swarm_CMD m))

(cl:ensure-generic-function 'leader_pos-val :lambda-list '(m))
(cl:defmethod leader_pos-val ((m <SwarmCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:leader_pos-val is deprecated.  Use prometheus_msgs-msg:leader_pos instead.")
  (leader_pos m))

(cl:ensure-generic-function 'leader_vel-val :lambda-list '(m))
(cl:defmethod leader_vel-val ((m <SwarmCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:leader_vel-val is deprecated.  Use prometheus_msgs-msg:leader_vel instead.")
  (leader_vel m))
...
(cl:defmethod target_area_x_min-val ((m <SwarmCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:target_area_x_min-val is deprecated.  Use prometheus_msgs-msg:target_area_x_min instead.")
  (target_area_x_min m))

(cl:ensure-generic-function 'target_area_y_min-val :lambda-list '(m))
(cl:defmethod target_area_y_min-val ((m <SwarmCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:target_area_y_min-val is deprecated.  Use prometheus_msgs-msg:target_area_y_min instead.")
  (target_area_y_min m))

(cl:ensure-generic-function 'target_area_x_max-val :lambda-list '(m))
(cl:defmethod target_area_x_max-val ((m <SwarmCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:target_area_x_max-val is deprecated.  Use prometheus_msgs-msg:target_area_x_max instead.")
  (target_area_x_max m))

(cl:ensure-generic-function 'target_area_y_max-val :lambda-list '(m))
(cl:defmethod target_area_y_max-val ((m <SwarmCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:target_area_y_max-val is deprecated.  Use prometheus_msgs-msg:target_area_y_max instead.")
  (target_area_y_max m))

(cl:ensure-generic-function 'attack_target_pos-val :lambda-list '(m))
(cl:defmethod attack_target_pos-val ((m <SwarmCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:attack_target_pos-val is deprecated.  Use prometheus_msgs-msg:attack_target_pos instead.")
  (attack_target_pos m))

(cl:ensure-generic-function 'formation_poses-val :lambda-list '(m))
(cl:defmethod formation_poses-val ((m <SwarmCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:formation_poses-val is deprecated.  Use prometheus_msgs-msg:formation_poses instead.")
  (formation_poses m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SwarmCommand>)))
  ...
  "15ee071c075d4bbef4208b6edf6e01f1")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SwarmCommand)))
  "Returns md5sum for a message object of type 'SwarmCommand"
  "15ee071c075d4bbef4208b6edf6e01f1")
