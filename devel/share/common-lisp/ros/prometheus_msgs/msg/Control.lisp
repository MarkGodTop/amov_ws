...
(cl:defmethod cl:initialize-instance :after ((m <Control>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Control)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name prometheus_msgs-msg:<Control> is deprecated: use prometheus_msgs-msg:Control instead.")))

(cl:ensure-generic-function 'mouse-val :lambda-list '(m))
(cl:defmethod mouse-val ((m <Control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:mouse-val is deprecated.  Use prometheus_msgs-msg:mouse instead.")
  (mouse m))
