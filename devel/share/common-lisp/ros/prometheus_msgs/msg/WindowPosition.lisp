...
(cl:defmethod cl:initialize-instance :after ((m <WindowPosition>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WindowPosition)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name prometheus_msgs-msg:<WindowPosition> is deprecated: use prometheus_msgs-msg:WindowPosition instead.")))
...
(cl:defmethod origin_x-val ((m <WindowPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:origin_x-val is deprecated.  Use prometheus_msgs-msg:origin_x instead.")
  (origin_x m))

(cl:ensure-generic-function 'origin_y-val :lambda-list '(m))
(cl:defmethod origin_y-val ((m <WindowPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:origin_y-val is deprecated.  Use prometheus_msgs-msg:origin_y instead.")
  (origin_y m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <WindowPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:width-val is deprecated.  Use prometheus_msgs-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <WindowPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:height-val is deprecated.  Use prometheus_msgs-msg:height instead.")
  (height m))

(cl:ensure-generic-function 'window_position_x-val :lambda-list '(m))
(cl:defmethod window_position_x-val ((m <WindowPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:window_position_x-val is deprecated.  Use prometheus_msgs-msg:window_position_x instead.")
  (window_position_x m))

(cl:ensure-generic-function 'window_position_y-val :lambda-list '(m))
(cl:defmethod window_position_y-val ((m <WindowPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:window_position_y-val is deprecated.  Use prometheus_msgs-msg:window_position_y instead.")
  (window_position_y m))

(cl:ensure-generic-function 'track_id-val :lambda-list '(m))
(cl:defmethod track_id-val ((m <WindowPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:track_id-val is deprecated.  Use prometheus_msgs-msg:track_id instead.")
  (track_id m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<WindowPosition>)))
  ...
  "prometheus_msgs/WindowPosition")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'WindowPosition)))
  "Returns string type for a message object of type 'WindowPosition"
  "prometheus_msgs/WindowPosition")
