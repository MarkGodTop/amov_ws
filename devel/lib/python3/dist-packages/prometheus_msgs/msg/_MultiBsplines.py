...
"""autogenerated by genpy from prometheus_msgs/MultiBsplines.msg. Do not edit."""
import codecs
import sys
...
class MultiBsplines(genpy.Message):
  ...
  _type = "prometheus_msgs/MultiBsplines"
...
"""
  ...
  _slot_types = ['int32','prometheus_msgs/Bspline[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = prometheus_msgs.msg.Bspline()
        _x = val1
        start = end
        end += 16
