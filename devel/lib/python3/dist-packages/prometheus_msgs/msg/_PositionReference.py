...
class PositionReference(genpy.Message):
  _md5sum = "5aa100275600b3aa2239f15be9b50ba5"
...
"""
  ...
  __slots__ = ['header','Move_mode','Move_frame','time_from_start','position_ref','velocity_ref','acceleration_ref','yaw_ref']
  _slot_types = ['std_msgs/Header','uint8','uint8','float32','float32[3]','float32[3]','float32[3]','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,Move_mode,Move_frame,time_from_start,position_ref,velocity_ref,acceleration_ref,yaw_ref
