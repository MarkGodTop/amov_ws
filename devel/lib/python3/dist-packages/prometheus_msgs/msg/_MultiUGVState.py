...
"""autogenerated by genpy from prometheus_msgs/MultiUGVState.msg. Do not edit."""
import codecs
import sys
...
class MultiUGVState(genpy.Message):
  ...
  _type = "prometheus_msgs/MultiUGVState"
...
"""
  ...
  _slot_types = ['std_msgs/Header','int32','prometheus_msgs/UGVState[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = prometheus_msgs.msg.UGVState()
        _v4 = val1.header
        start = end
        end += 4
