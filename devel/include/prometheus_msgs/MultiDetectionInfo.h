...
struct MultiDetectionInfo_
{
  ...
  _detect_or_track_type detect_or_track;
   ...
   typedef std::vector< ::prometheus_msgs::DetectionInfo_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::prometheus_msgs::DetectionInfo_<ContainerAllocator> >> _detection_infos_type;
